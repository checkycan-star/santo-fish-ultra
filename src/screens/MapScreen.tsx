  ...
  return L.divIcon({
    ...
    html: `
      <span style="position:relative;display:flex;align-items:center;justify-content:center;width:28px;height:28px;">
        <span style="position:absolute;inset:0;border-radius:999px;background:rgb(24 191 255 / 0.18);animation:catch-ping 2.4s ease-out infinite;"></span>
        <span style="position:relative;display:block;width:14px;height:14px;border-radius:999px;background:linear-gradient(135deg,#18BFFF,#0f8bf5);border:2px solid #e0f7fe;box-shadow:0 0 0 3px rgb(24 191 255 / 0.3),0 2px 6px rgb(0 0 0 / 0.5);"></span>
      </span>`,
    iconSize: [28, 28],
    iconAnchor: [14, 14],
    popupAnchor: [0, -14],
  ...
  return L.divIcon({
    ...
    html: `
      <span style="position:relative;display:flex;align-items:center;justify-content:center;width:24px;height:24px;">
        <span style="position:absolute;inset:0;border-radius:999px;background:rgb(24 191 255 / 0.25);animation:user-pulse 2s ease-out infinite;"></span>
        <span style="position:relative;display:block;width:12px;height:12px;border-radius:999px;background:#18BFFF;border:2px solid #fff;box-shadow:0 0 8px 2px rgb(24 191 255 / 0.6);"></span>
      </span>`,
    iconSize: [24, 24],
    iconAnchor: [12, 12],
  });
  ...
  return (
    <div className="relative z-10 flex h-full flex-col">
          ...
          >
            <div className="relative h-full w-full overflow-hidden rounded-2xl border border-lake-400/15 shadow-lift">
              <MapContainer
                ...
                scrollWheelZoom
                className="h-full w-full deep-sea-map"
                style={{ background: 'linear-gradient(180deg, #0b2f52 0%, #04101f 100%)' }}
              >
                <TileLayer
              ...
              {/* Deep-sea pearlescent color grade — sits above the map, doesn't block interaction */}
              <div className="pointer-events-none absolute inset-0 z-[500] deep-sea-tint" />
              <div className="pointer-events-none absolute inset-0 z-[500] deep-sea-shimmer" />
      ...
      <style>{`
        ...
        @keyframes deep-sea-shimmer-move {
          0% { background-position: -60% -60%, 0 0; }
          100% { background-position: 160% 160%, 0 0; }
        }
        .deep-sea-map .leaflet-tile-pane {
          filter: saturate(1.15) brightness(0.72) contrast(1.08) hue-rotate(6deg);
        }
        .deep-sea-tint {
          background: linear-gradient(
            180deg,
            rgba(56, 168, 255, 0.34) 0%,
            rgba(15, 63, 115, 0.30) 40%,
            rgba(6, 20, 38, 0.50) 72%,
            rgba(0, 3, 10, 0.70) 100%
          );
          mix-blend-mode: multiply;
        }
        .deep-sea-shimmer {
          background:
            radial-gradient(ellipse 70% 45% at 20% 15%, rgba(180, 235, 255, 0.30), transparent 60%),
            linear-gradient(115deg, transparent 30%, rgba(200, 240, 255, 0.14) 45%, rgba(140, 210, 255, 0.07) 55%, transparent 70%);
          background-size: 100% 100%, 220% 220%;
          background-repeat: no-repeat;
          mix-blend-mode: screen;
          opacity: 0.55;
          animation: deep-sea-shimmer-move 9s ease-in-out infinite alternate;
        }
        .leaflet-container { font-family: 'Manrope', system-ui, sans-serif; background: #031525 !important; }
